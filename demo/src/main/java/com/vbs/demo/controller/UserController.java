...
@RestController
@CrossOrigin(origins = "*")//allows communication between ports
public class UserController {
    @Autowired  //user repo ka obj nhi ban sakta islye ye use kiya
    UserRepo userRepo;
    ...
    public String login(@RequestBody LoginDto u) {
        ...
        return String.valueOf(user.getId());//to convert int to string
    }


    @GetMapping("/get-details/{id}")
    public DisplayDto display(@PathVariable int id) {//why displaydto??we have to return more than one value hence we are making a different class and making its obj and returning obj
